...
def url_lookup(url):
    """
    Realiza una búsqueda de URL utilizando la API de API Ninjas y devuelve la respuesta en formato JSON.
    """
    ...
    api_url = f'https://api.api-ninjas.com/v1/urllookup?url={url}'
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        url_lookup(sys.argv[1])
    else:
        print("Usage: url_lookup.py <URL>")
